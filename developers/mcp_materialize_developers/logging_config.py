...
class StructuredFormatter(logging.Formatter):
    ...
    def __init__(
        self, service_name: str = "materialize_mcp_server", version: str = "1.0.0"
    ):
        super().__init__()
...
def log_database_operation(
    ...
    """
    extra_data = {"event_type": "database_operation", "operation": operation}
    ...
    logger.debug(f"Database operation: {operation}", extra=extra_data)
